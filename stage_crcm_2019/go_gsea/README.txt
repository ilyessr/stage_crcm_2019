...
Gene Set Enrichment Analysis of KEGG pathways to find which
pathways are over-represented (or under-represented)

-----

**Input**

List of set of ID genes/proteins
List of ID genes/proteins background
...
A HTML report with a table containing the over-represented GO
